                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="nama_pemesan" name="nama_pemesan" type="text" class="form-control" value="<?= $result['nama_pemesan'] ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="alamat_pemesan" rows="2" cols="30" readonly><?= $result['alamat_pemesan'] ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="qty">Jumlah<abbr class="required" title="required">*</abbr></label>
                                                    <input id="qty" name="qty" type="number" class="form-control" min="1" value="<?= $result['qty'] ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="order-details-table-wrap table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody class="table-body">
                                            <tr class="cart-item">
                                                <td class="product-name"><?= $result['nama_produk'] ?>
                                                    <span class="product-quantity" id="quantity">x <?= $result['qty'] ?></span>
                                                </td>
                                                <td class="product-total" id="harga"><?= $result['total_harga'] ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
